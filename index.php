...
<body>
	...
	<div id="prepared" style="display:none;">
		...
		<ul class="b_dropdown post_tools">
			...
			<li>
				<a class="trash_post">🗑️ <?php echo __("Move to Trash"); ?></a>
				<a class="restore_post">♻️ <?php echo __("Restore from Trash"); ?></a>
			</li>
		...
		<div class="modal delete_modal">
			<div class="modal-dialog small">
				<div class="modal-content">
					...
					<div class="modal-body"><?php echo __("This will permanently delete the post. This action cannot be undone."); ?></div>
					<div class="modal-footer">
						<div class="buttons">
							<a class="button gray close"><?php echo __("Cancel"); ?></a>
